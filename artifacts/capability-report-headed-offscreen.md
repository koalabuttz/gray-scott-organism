...
Generated: 2026-09-20T00:17:58.488Z

Overall: **PASS**

## Renderer

- Unmasked renderer: `ANGLE (Intel, Mesa Intel(R) Graphics (RPL-U), OpenGL ES 3.2)`
...
- IMPLEMENTATION_COLOR_READ_FORMAT/TYPE: RGB / UNSIGNED_BYTE
...
- Playwright project: `headed-offscreen`
- Mode: headed, window positioned at -32000,-32000 so it never appears on screen or takes foreground focus (not started minimized: a minimized window throttles rAF and would invalidate the timing assertions)
- Launch arguments: `--no-sandbox --disable-dev-shm-usage --ignore-gpu-blocklist --enable-unsafe-swiftshader --use-gl=angle --use-angle=gl-egl --window-position=-32000,-32000`
- Renderer reached by this run: `ANGLE (Intel, Mesa Intel(R) Graphics (RPL-U), OpenGL ES 3.2)`
