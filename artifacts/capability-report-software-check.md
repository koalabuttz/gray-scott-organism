...
Generated: 2026-09-20T00:21:04.388Z

Overall: **PASS**

## Renderer

- Unmasked renderer: `ANGLE (Google, Vulkan 1.3.0 (SwiftShader Device (Subzero) (0x0000C0DE)), SwiftShader driver)`
- Unmasked vendor: `Google Inc. (Google)`
- Renderer is a software rasteriser: **true**
...
- Playwright project: `software-check`
...
- Launch arguments: `--no-sandbox --disable-dev-shm-usage --ignore-gpu-blocklist --enable-unsafe-swiftshader --use-angle=swiftshader`
- Renderer reached by this run: `ANGLE (Google, Vulkan 1.3.0 (SwiftShader Device (Subzero) (0x0000C0DE)), SwiftShader driver)`
- Software rasteriser: **true**
